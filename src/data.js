export const placeInfo = [
  {
    id: 1,
    headerTitle: 'Currency Exchange Calculator',
    headerSubTitle: 'Whats the damage',
    headerText:
      'Enjoy the new currency exhange component to see how far your USD takes you in Latvia',
    description:
      'Enjoy the new currency exhange component to see how far your USD takes you in Latvia',
    img: '.././images/riga2.jpg',
    maps:
  ...
  {
    id: 2,
    headerTitle: 'Apartment Search',
    headerSubTitle: 'Available Apartments',
    headerText:
      'Search for available apartments in Riga.',
    description:
      'Locating an apartment in Riga can be difficult if you dont speak the language. Here is a tool to assist you in your search!',
    img: '.././images/riga3.jpg',
    maps:
  ...
  },
  {
    ...
    headerSubTitle: 'food in this bih',
    headerText:
      'Locating food near you! Also finding new things to try!',
    title:
      'Find me food!',
    description:
